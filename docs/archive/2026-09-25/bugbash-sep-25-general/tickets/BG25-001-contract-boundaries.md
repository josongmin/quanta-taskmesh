...
- **필수 외부 인계:** 배포 owner가 D1–D9별 실제 진입점, 해당/비해당 근거, 호환성·migration 결정을 검토하고 서명한다. 범위는 [EXTERNAL-ADOPTION](../../../../plans/bugbash-sep-25-general/tickets/EXTERNAL-ADOPTION.md)의 Semantica 후보와 아직 미확인인 다른 배포 소비자다. 담당 저장소·호출점·owner·그 저장소의 source-bound 결과가 없으면 OPEN이다.
