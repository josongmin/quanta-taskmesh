...
> Archived implementation plan. The skeleton descriptions below are the
> historical starting point; current authority is in
> [ADR 0001](../../../adr/0001-hexagonal-feature-sliced-architecture.md)
> and the [library spec](../../../taskmesh-library-spec.md).
