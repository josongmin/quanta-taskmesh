...
> Archived implementation packet. The original source and receipt statements
> below retain their historical scope. Current decisions are in
> [ADR 0003](../../../../adr/0003-sep-16-hardening-contracts.md) and later ADRs;
> unresolved qualification and adoption are tracked separately.
...
- 구현 직후 3-track 적대적 감사(engine/runtime · 증명 강도 · tooling/CI/docs)를 실행했고 P0 3건·P1 12건·
  ...
  적대 감사를 처리했다: [AUDIT-2026-09-16](../../../../plans/sep-16-hardening/AUDIT-2026-09-16.md). 계약 변경은 ADR 0003
...
```sh
python3 docs/archive/2026-09-25/sep-16-hardening/tickets/validate_plan.py
```
