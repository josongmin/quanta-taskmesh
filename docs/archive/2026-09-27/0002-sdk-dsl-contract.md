> **Historical / superseded — archived 2026-09-27.**
> This is the SEP-24 proposal at its original source baseline, not the current backlog.
> Duplicate-policy rejection and the direct/host settlement notification are now implemented.
> Current proposal: [SEP-27 SDK DX and extensibility](../../rfc/sep-27-sdk-dx-extensibility.md).
> The original text below is retained unchanged for design history; its “current” and “proposed”
> labels refer to the original baseline only. It is not qualification evidence.
