...
| Q10 | PM branding/template drift | [H16-020](H16-020-pm-validated-render-plan.md), [H16-021](H16-021-quality-and-doc-migration.md) | **RETIRED** (계획: FIX) | owner target이 0인 vacuous PM subsystem과 required gate를 제거; 실제 target이 생기면 owner와 함께 재설계 |
...
| Q23 | PM path containment | [H16-020](H16-020-pm-validated-render-plan.md) | **RETIRED** (계획: DECIDE) | PM subsystem 제거로 runtime path surface가 없어짐; 향후 실제 target과 함께 containment contract 재도입 |
